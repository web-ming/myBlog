<template>
	<div ref="container" class="vue-pull-refresh">
		<div class="vue-pull-refresh-msg" :class='{opacity: isOpacity}'>
			<template v-if="loading">
				<svg t="1497367491334" viewBox="0 0 1024 1024" class="vue-pull-refresh-loading" style="width: 1.2em; height: 1.2em;vertical-align: middle;fill: currentColor;overflow: hidden;"
			...
			<template v-else>
				<svg t="1497366759944" viewBox="0 0 1024 1024" :class="{'icon-reverse': flag}" style="width: 1rem; height: 1rem; vertical-align: middle;fill: currentColor;overflow: hidden;"
